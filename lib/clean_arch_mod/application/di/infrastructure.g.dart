...
String _$firebaseHash() => r'd381f9dfd73925fe1eb70aee136ef5069b425436';

/// Firebase
///
/// Copied from [firebase].
@ProviderFor(firebase)
final firebaseProvider = Provider<FirebaseService>.internal(
  firebase,
...
/// Copied from [logger].
@ProviderFor(logger)
final loggerProvider = Provider<CleanArchLogger>.internal(
  logger,
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef LoggerRef = ProviderRef<CleanArchLogger>;
