...
class PageH1 extends StatefulWidget {
  const PageH1({super.key});

  @override
  State<PageH1> createState() => _PageH1State();
}

class _PageH1State extends State<PageH1> {
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                color: switch (chartNumber) {
                  0 => Colors.white.withOpacity(0.5),
